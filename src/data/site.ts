...
import { CHARACTER_SOCIALS } from "./social";
...
const DATA_ES = {
	characters: [
		{
			...
			photo: "/images/crew/miguelin.webp",
			episodeCount: 65,
			color: "#FF0055",
			...
			bestMoments: [
				...
				{
					title: "Miguelín vs El Moreno rap battle",
					episode: 41,
					views: "1.8M",
				},
			...
			featuredEpisodes: [
				...
				{
					number: 55,
					title: "La confesión que nadie esperaba",
					topic: "Confesiones",
				},
				{
					number: 65,
					title: "65 episodios de locura",
					topic: "Especial aniversario",
				},
			],
		},
		{
			...
			photo: "/images/crew/la-flaca-veronica.webp",
			episodeCount: 32,
			color: "#FF0055",
		...
		},
		{
			...
			photo: "/images/crew/laurita.webp",
			episodeCount: 48,
			color: "#00E5FF",
		...
		},
		{
			...
			photo: "/images/crew/el-moreno.webp",
			episodeCount: 28,
			color: "#FFD600",
		...
		},
		{
			...
			photo: "/images/crew/la-melliza.webp",
			episodeCount: 22,
			color: "#E040FB",
			...
			bestMoments: [
				{
					title: "La reacción que rompió internet",
					episode: 35,
					views: "2.5M",
				},
		...
		},
		{
			...
			photo: "/images/crew/ernesto.webp",
			episodeCount: 65,
			color: "#4CAF50",
			...
			bestMoments: [
				{
					title: "Ernesto aparece en cámara por error",
					episode: 20,
					views: "1.4M",
				},
	...
	latestEpisode: {
		...
		duration: "1h 45min",
		thumbnail:
			"https://placehold.co/800x450/111111/FF0055?text=EP+65+%7C+ESPECIAL",
	} satisfies Episode,

	viralEpisodes: [
		{
			number: 60,
			title: "El episodio viral de Verónica",
			guest: "La Flaca Verónica",
			views: "4.1M",
			thumbnail: "https://placehold.co/400x225/111111/FF0055?text=EP+60",
		},
		{
			number: 55,
			title: "La confesión inesperada",
			guest: "Miguelín",
			views: "3.2M",
			thumbnail: "https://placehold.co/400x225/111111/00E5FF?text=EP+55",
		},
		{
			number: 51,
			title: "Laurita vs Verónica",
			guest: "Laurita & Verónica",
			views: "2.7M",
			thumbnail: "https://placehold.co/400x225/111111/FFD600?text=EP+51",
		},
		{
			number: 48,
			title: "Karaoke en el podcast",
			guest: "La Melliza",
			views: "2.5M",
			thumbnail: "https://placehold.co/400x225/111111/E040FB?text=EP+48",
		},
		{
			number: 45,
			title: "Debate explosivo",
			guest: "La Flaca Verónica",
			views: "1.5M",
			thumbnail: "https://placehold.co/400x225/111111/FF0055?text=EP+45",
		},
		{
			number: 41,
			title: "Rap battle en el podcast",
			guest: "El Moreno",
			views: "1.9M",
			thumbnail: "https://placehold.co/400x225/111111/FFD600?text=EP+41",
		},
	...
	guests: [
		{
			name: "El Taiger",
			photo: "https://placehold.co/200x200/111111/FF0055?text=El+Taiger",
		},
		{
			name: "Jacob Forever",
			photo: "https://placehold.co/200x200/111111/00E5FF?text=Jacob+Forever",
		},
		{
			name: "Otaola",
			photo: "https://placehold.co/200x200/111111/FFD600?text=Otaola",
		},
		{
			name: "La Diosa",
			photo: "https://placehold.co/200x200/111111/E040FB?text=La+Diosa",
		},
		{
			name: "Descemer Bueno",
			photo: "https://placehold.co/200x200/111111/FF0055?text=Descemer",
		},
		{
			name: "El Chacal",
			photo: "https://placehold.co/200x200/111111/00E5FF?text=El+Chacal",
		},
		{
			name: "Lenier",
			photo: "https://placehold.co/200x200/111111/FFD600?text=Lenier",
		},
		{
			name: "Yomil",
			photo: "https://placehold.co/200x200/111111/E040FB?text=Yomil",
		},
	] satisfies Guest[],
	...
	nextEvent: {
		...
		date: "Abril 2026",
		description:
			"El podcast en vivo con todo el crew y invitados sorpresa. Una noche de locuras, risas y mucho más.",
		link: "#",
	} satisfies Event,
	...
	viralClips: [
		{
			title: "Miguelín se cae de la silla",
			views: "5.2M",
			thumbnail: "https://placehold.co/300x535/111111/FF0055?text=CLIP+1",
		},
		{
			title: "Verónica dice la verdad",
			views: "3.8M",
			thumbnail: "https://placehold.co/300x535/111111/00E5FF?text=CLIP+2",
		},
		{
			title: "El Moreno freestyle",
			views: "2.9M",
			thumbnail: "https://placehold.co/300x535/111111/FFD600?text=CLIP+3",
		},
		{
			title: "La Melliza reacciona",
			views: "4.1M",
			thumbnail: "https://placehold.co/300x535/111111/E040FB?text=CLIP+4",
		},
	] satisfies ViralClip[],
};
...
const DATA_EN = {
	...
	nextEvent: {
		...
		date: "April 2026",
		description:
			"The live podcast with the whole crew and surprise guests. A night of craziness, laughs and much more.",
	},
};
